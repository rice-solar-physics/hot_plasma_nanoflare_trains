...
%
	...
	\begin{figure}
		...
		\caption{Power-law distributions of heating events for indices $\alpha=-1.5,-2.0,-2.5$ for a given heating frequency, $t_N=2500$ s. For each frequency, $t_N$, we compute $N_R$ runs such that the total number of events simulated for each $t_N$ is $N\times N_R\sim10^4$.}
