...
%
	...
	\begin{figure*}[t]
		\centering
		\caption{EM grids will go here, electron heating}
		\label{fig:el_em}
	\end{figure*}
	%
	\begin{figure*}
		\centering
		\caption{EM grids will go here, ion heating}
		\label{fig:ion_em}
	\end{figure*}
	%
	...
	\begin{figure*}
		\centering
		\caption{\hl{Maybe single EM grid will go here}}
	\end{figure*}
	%
	...
	\begin{figure*}
		\centering
		\caption{\hl{Put EM ratio histograms here, maybe include hot slope histograms somewhere too}}
			\label{fig:histos}
	\end{figure*}
	%
